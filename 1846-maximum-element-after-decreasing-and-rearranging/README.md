...
<pre class="button-container"><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="c28gx"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="s4449p"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="cz0ob"><span>a2svify</span></button><strong>Input:</strong> arr = [2,2,1,2,1]
...
<pre class="button-container"><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="wr8gf"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="ewh1xi"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="p39pq5"><span>a2svify</span></button><button type="button" class="a2sv-button" fdprocessedid="106tn"><span>a2svify</span></button><strong>Input:</strong> arr = [100,1,1000]
